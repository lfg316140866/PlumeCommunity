...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <style>
        ...
        .expression-float li{text-align:left}
                    ...
                    <div class="desc-box list-box">
                        ...
                        <div class="comment-input">
                           ...
                           <input id="Comment_Input" type="text" placeholder="我也说一句" name=""/>
                            ...
                            <span class="expression icons-sprite"></span>
                            <div class="comment-bar" style="position:absolute">
                                ...
                                <div id="Comment_Input" style="position: absolute;min-width:415px" class="comment-con" placeholder="我也说一句" contenteditable="true"></div>
                            </div>
                            <button class="reviews-btn general-font">评论</button>
