...
<body>
                ...
                <div class="Inner">
                    ...
                    <div class="release-filter JscStickersDiv JscOperatingHide">
                        <div class="filter-bar">
                            ...
                            <ul class="filter-nav tags-box">
                                <!--选中滤镜添加a标签select-->
                                <li sid="" class="JscStickersElements dat-StickerCategoryID-sid"><a href="javascript:void(0)" class=""><img class="dat-PicPath-src" src="images/filter-color.png" /><span class="dat-StickerCategoryDesc">原图</span></a></li>
                            </ul>
                        </div>
                    </div>
   ...
   <div class="papercut-float JscStickersShow JscOperatingHide">
       <div class="papercut-box">
             <!-----------熊猫贴纸---------->
             <div class="panda-box sticker-box">
                    <ul>
                        <li><a href="javascript:void(0)"><img src="images/sticker/big/panda/panda-1.png" /></a></li>
             ...
             <!-----------文字贴纸---------->
             <div class="words-box sticker-box">
                    <ul>
                        <li><a href="javascript:void(0)"><img src="images/sticker/big/text/text-1.png" /></a></li>
             ...
             <!-----------包子贴纸---------->
            <div class="steamed -box sticker-box">
                    <ul>
                        <li><a href="javascript:void(0)"><img src="images/sticker/big/bumpkin/bumpkin-1.png" /></a></li>
                        <li><a href="javascript:void(0)"><img src="images/sticker/big/bumpkin/bumpkin-2.png" /></a></li>
                        <li><a href="javascript:void(0)"><img src="images/sticker/big/bumpkin/bumpkin-3.png" /></a></li>
                        <li><a href="javascript:void(0)"><img src="images/sticker/big/bumpkin/bumpkin-4.png" /></a></li>
                        <li><a href="javascript:void(0)"><img src="images/sticker/big/bumpkin/bumpkin-5.png" /></a></li>
                        <li><a href="javascript:void(0)"><img src="images/sticker/big/bumpkin/bumpkin-6.png" /></a></li>
                    </ul>
            </div>
             <!-----------气节贴纸---------->
            <div class="integrity-box sticker-box">
                    <ul>
                        <li><a href="javascript:void(0)"><img src="images/sticker/big/solarterm/solarterm-1.png" /></a></li>
                        <li><a href="javascript:void(0)"><img src="images/sticker/big/solarterm/solarterm-2.png" /></a></li>
                        <li><a href="javascript:void(0)"><img src="images/sticker/big/solarterm/solarterm-3.png" /></a></li>
                        <li><a href="javascript:void(0)"><img src="images/sticker/big/solarterm/solarterm-4.png" /></a></li>
                    </ul>
            </div>
             <!-----------中国元素贴纸---------->
            <div class="element-box sticker-box">
                    <ul>
                        <li><a href="javascript:void(0)"><img src="images/sticker/big/element/element-1.png" /></a></li>
                        <li><a href="javascript:void(0)"><img src="images/sticker/big/element/element-2.png" /></a></li>
                        <li><a href="javascript:void(0)"><img src="images/sticker/big/element/element-3.png" /></a></li>
                        <li><a href="javascript:void(0)"><img src="images/sticker/big/element/element-4.png" /></a></li>
                    </ul>
            </div>
             <!-----------生肖贴纸---------->
            <div class="zodiac-box sticker-box">
                    <ul>
                        <li><a href="javascript:void(0)"><img src="images/sticker/big/zodiac/zodiac-1.png" /></a></li>
                        <li><a href="javascript:void(0)"><img src="images/sticker/big/zodiac/zodiac-2.png" /></a></li>
                        <li><a href="javascript:void(0)"><img src="images/sticker/big/zodiac/zodiac-3.png" /></a></li>
                        <li><a href="javascript:void(0)"><img src="images/sticker/big/zodiac/zodiac-4.png" /></a></li>
                    </ul>
            </div>
             <!-----------古诗贴纸---------->
             <div class="poetry-box sticker-box">
                    <ul>
                        <li><a href="javascript:void(0)"><img src="images/sticker/big/poetry/poetry-1.png" /></a></li>
                        <li><a href="javascript:void(0)"><img src="images/sticker/big/poetry/poetry-2.png" /></a></li>
                        <li><a href="javascript:void(0)"><img src="images/sticker/big/poetry/poetry-3.png" /></a></li>
                        <li><a href="javascript:void(0)"><img src="images/sticker/big/poetry/poetry-4.png" /></a></li>
                    </ul>
             </div>
             <!-----------季节贴纸---------->
             <div class="season-box sticker-box">
                    <ul>
                        <li><a href="javascript:void(0)"><img src="images/sticker/big/season/season-1.png" /></a></li>
                        <li><a href="javascript:void(0)"><img src="images/sticker/big/season/season-2.png" /></a></li>
                        <li><a href="javascript:void(0)"><img src="images/sticker/big/season/season-3.png" /></a></li>
                        <li><a href="javascript:void(0)"><img src="images/sticker/big/season/season-4.png" /></a></li>
                    </ul>
             </div>
       </div>
       <div class="papercut-bar">
           ...
           <ul class="papercut-nav tags-box">
               <li ssid="" class="JscStickersElementsSon dat-StickerID-ssid"><a href="javascript:void(0)" class=""><img class="dat-PicPath-src" src="images/filter-color.png" /><span class="dat-StickerDesc">的萨达粉丝</span></a></li>
           </ul>
       </div>
   </div>
    <!---------------底部导航-------------------->
