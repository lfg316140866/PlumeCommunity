...
<body>
        ...
        <div class="Main cmn-ScenesContainer">
            ...
            <div class="cmn-Scenes PublicScenes choice" id="choice">
                <div class="filter-des JscPhotoCanvas">
                    <a href="javascript:void(0)" class="btn-sprite JscChoice" style="
                        width: 34px;
                        height: 34px;
                ...
                <div class="Inner">
                    ...
                    <div class="release-filter JscStickersDiv JscOperatingHide">
                       ...
                       <!---------------剪纸选择浮层-------------------->
           <div class="papercut-float JscStickersShow JscOperatingHide" style="position:fixed">
               <div class="papercut-box">
                     <!-----------熊猫贴纸---------->
                     <div class="panda-box sticker-box JscFourPhoto">
                            <ul>
                                <li class="JscFourPhotoElement"><a href="javascript:void(0)"><img class="dat-PicPath-src" src="images/sticker/big/panda/panda-1.png" /></a></li>
                     ...
                     <div class="words-box sticker-box JscSixPhoto">
                            <ul>
                                <li class="JscSixPhotoElement"><a href="javascript:void(0)"><img class="dat-PicPath-src" src="images/sticker/big/text/text-1.png" /></a></li>
               ...
               <div class="papercut-bar JscArrowAll">
                   ...
                   <ul class="papercut-nav tags-box JscTagsList">
                       <li ssid="" class="JscStickersElementsSon dat-StickerCategoryID-ssid"><a href="javascript:void(0)" class=""><img class="dat-PicPath-src" src="images/filter-color.png" /><span class="dat-StickerCategoryDesc">的萨达粉丝</span></a></li>
                   </ul>
               </div>
           </div>
                    <!--发布(自定义标签)-->
    ...
    <div class="pop-float JscLableFloat">
        ...
        <div class="tag-float JscLableShowFloat">
            <div class="header-search">
                <div class="search-input"><input class="JscLableText" maxlength="9" type="text" placeholder="中国美女"/></div>
