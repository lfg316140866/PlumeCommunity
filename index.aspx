...
<head>
    ...
    <meta property="qc:admins" content="26347700571166556317756375" />
...
<body>
                ...
                <div class="Inner JscHideMenu">
                    ...
                    <div class="more-land">
                        <ul class="more-land-nav">
                            ...
                            <li><a href="<%=_QQUrl %>" class="btn-sprite"></a></li>
                            <li><a href="<%=_SinaUrl%>" class="btn-sprite"></a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <!---------------顶部菜单-------------------->
    <div class="header-box JscHideAllHeader" style="display:none;z-index:222222;">
    ...
    <div class="pop-float JscFloatAll">
        ...
        <div class="success-float JscFloatAllHide">
            ...
            <div class="success-arrow2"><img  src="images/load.png" lazypath="images/success-arrow2.png" /></div>
        ...
        <div class="register-finish-float JscInformationFloat JscFloatAllHide">
            ...
            <div class="register-finish-box info-box">
                <input maxlength="7" type="text" name="" placeholder="输入您的昵称" class="register-phone pub-input JscInformationNameText"/>
                <!-------验证用户名是否被用-------->
    ...
    <script>
        Cmn.Func.MobileAdaptive(640, 1040, "images/AdviseVertical.png", Cmn.Func.MobileAdaptiveMode.WidthHeight);
    </script>
</body>
</html>