...
$(document).ready(function () {
    ...
    $(".DescMain").on("click", ".list-desc", function (event) {
        event.stopPropagation();
        var _self = $(this); $(".comment-input input").focus();
       
        $(".comment-input input").attr({ "placeholder": "回复" + _self.find(".comment-name").html(),"replyuserid":_self.attr("userid")});
    });


    $(".DescMain .Inner").click(function() {
        $(".comment-input input").attr({ "placeholder": "我也说一句", "replyuserid": "" });
    });
