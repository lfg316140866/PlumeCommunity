...
$(function () {
    ...
    if (_labelID != "") {
        ...
        $(".search-key-list").show().siblings(".list").hide();
        var _list = new CmnAjax.DataStepLoad(".search-key-list li", "/Itf/CSharp/Interface.aspx?method=GetWorkListByLabel", _param, ".search-key-list", 1000, 24,function() {
             _list.BindScrollLoadData(".search-key-list .search-pub");
        $(".search-key-list li:hidden").show();
        });
    ...
    $("#SeachBtn").on("touchend", function() {
        ...
        if ($(".search-nav .select").index(".search-nav a") == 0) {
            ...
            $(".search-key-list").show().siblings(".list").hide();
            var _list = new CmnAjax.DataStepLoad(".search-key-list li", "/Itf/CSharp/Interface.aspx?method=GetWorkListLikeLabel", _param, ".search-key-list", 1000, 24,function() {
                _list.BindScrollLoadData(".search-key-list .search-pub");
                $(".search-key-list li:hidden").show();
            });
